...
const processPhotos = async (srcs)=>{
    ...
    for(let idx = 0; idx < total; idx++){
        const src = srcs[idx];
        const { img, data, quad } = src instanceof Blob || src instanceof ImageBitmap ? await preprocessPhoto(src) : src;
        ...
        const updateImageDimensions = ()=>{
            const { width, height } = idx === 0 ? calcDimensions(aspectRatio, 0.925) : firstDimensions;
            if (idx === 0) {
...
async function compressImage(src, maxDim = 1024, quality = 0.8) {
    let bitmap;
...
const onLoad = async ()=>{
    ...
    upload.onchange = async ()=>{
        ...
        try {
            ...
            const extracted = await Promise.all(pages.map(({ data, quad })=>(0, _process.extractDocument)(data, quad, 1224, true)));
            let pdfData;
            ...
            if (!isSafari && typeof OffscreenCanvas !== "undefined" && typeof new OffscreenCanvas(1, 1).convertToBlob === "function") {
                const worker = new Worker(require("9a4f18e550585161"));
            ...
            pdfData = await (0, _pdf.toPDF)(extracted);
            const pdfBlob = new Blob([
                pdfData
            ], {
                type: "application/pdf"
            });
            (0, _io.download)(pdfBlob, "out.pdf");
            pages.length = 0;
        } catch (err) {
    ...
    past.onclick = async ()=>{
        ...
        let ok = false;
        try {
            ok = await processPhotos(currPages);
        } catch (err) {
...
},{"./process":"iDoN4","./pdf":"7MOdo","./io":"l5h0N","url:./flash.svg":"frj0e","url:./flash-off.svg":"7Lx9R","url:./hd.svg":"lJttw","url:./sd.svg":"auXaD","image-capture":"3hNXr","9a4f18e550585161":"ka0YY","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"iDoN4":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function extractDocument(data, region, targetWidth, targetHeightOrTransfer, maybeTransfer) {
...
},{"cd434cd0b2046381":"26EJ3","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"26EJ3":[function(require,module,exports,__globalThis) {
let workerURL = require("ded55ce54b42aed0");
let url = new URL(module.bundle.resolve("process.5536d23c.js"));
module.exports = workerURL(url.toString(), url.origin, true);

},{"ded55ce54b42aed0":"30jT6"}],"30jT6":[function(require,module,exports,__globalThis) {
"use strict";
...
},{}],"7MOdo":[function(require,module,exports,__globalThis) {
/// <reference lib="dom" />
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"l5h0N":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./process":"iDoN4","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"frj0e":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("flash.173184de.svg") + "?" + Date.now();

},{}],"7Lx9R":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("flash-off.45486aba.svg") + "?" + Date.now();

},{}],"lJttw":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("hd.6ef184a8.svg") + "?" + Date.now();

},{}],"auXaD":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("sd.c02e67cf.svg") + "?" + Date.now();

},{}],"3hNXr":[function(require,module,exports,__globalThis) {
/**
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"ka0YY":[function(require,module,exports,__globalThis) {
let workerURL = require("e9490068de11c81f");
let url = new URL(module.bundle.resolve("pdfWorker.3a80bea4.js"));
module.exports = workerURL(url.toString(), url.origin, true);

},{"e9490068de11c81f":"30jT6"}]},["3dtlh","gH3Lb"], "gH3Lb", "parcelRequireed96", {}, "./", "/")

//# sourceMappingURL=scanner.34df32e0.js.map
